...
class HomeScreenForDesktop extends StatelessWidget {
  const HomeScreenForDesktop({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
        padding: EdgeInsets.only(
            left: DesktopDimensions.w30,
            right: DesktopDimensions.w30,
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                ...
                style: TextStyle(
                    fontSize: DesktopDimensions.detailsfontsize,
                    color: Colors.white),
              ),
              SizedBox(
